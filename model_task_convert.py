...
if __name__ == '__main__':
    ...
    parser.add_argument("--repo_id", type=str, default="sg2023/Gemma2-2B-IT-Sms-Verification_Code_Extraction")
    parser.add_argument("--tflite_model_path", type=str, default="./export/gemma2_sft_q8_ekv1024.tflite")
